...
namespace esphome
{
  namespace neopixel_bus
  {
    ...
    public:
      ...
      MappingsBuilder &add_mapping(PixelSetter *const bus, const uint16_t num_chips, const uint16_t ofs,
    ...
    template <std::size_t S>
    MappingsBuilder<S> &mappings_builder_create() { return *(new MappingsBuilder<S>()); }
